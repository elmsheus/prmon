...
class countmon final : public Imonitor {
 private:
  ...
  nlohmann::fifo_map<std::string, unsigned long long> count_stats;
  nlohmann::fifo_map<std::string, unsigned long long> count_peak_stats;
  nlohmann::fifo_map<std::string, unsigned long long> count_average_stats;
  nlohmann::fifo_map<std::string, unsigned long long> count_total_stats;
